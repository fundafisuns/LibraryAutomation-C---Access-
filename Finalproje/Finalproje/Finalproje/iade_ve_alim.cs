...
namespace Finalproje
{
    public partial class iade_ve_alim : Form
    {
        ...
        private void emanet_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int Sonuc = alim_iade_ekle.emanet_islemi(int.Parse(emanet_ktp_id_t.Text), int.Parse(emanet_ogr_id_t.Text), 
                    DateTime.Parse(emanet_tarih_t.Text), DateTime.Parse(emanet_tarih__son_t.Text), "alım");
        ...
        private void emanet_ktp_ara_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<kitaplar> ktp2 = kitap_islemler.kitap_goster(emanet_ktp_bilgi_t.Text, yer);
        ...
        private void emanet_ktp_kategori_cmb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            yer = emanet_ktp_kategori_cmb.SelectedItem.ToString();
        }
       ...
       private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        ...
        private void iade_ktp_ara_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                string yer = " ";
                yer = iade_ktp_kategori_cmb.SelectedItem.ToString();
                List<almaverme> kayit_cek_2 = islem_yap.kayit_listeleme2(iade_ktp_bilgi_t.Text, yer);
        ...
        private void iade_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int Sonuc = alim_iade_ekle.tablo_iade_duzenleme(int.Parse(iade_ktp_id_t.Text), int.Parse(iade_ogr_id_t.Text), "iade", iade_ktp_tarih_t.Text);
