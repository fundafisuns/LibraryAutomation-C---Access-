...
namespace Finalproje
{
    public partial class kitap_islemleri : Form
    {
        ...
        private string yer = " ";
        private kitap_islem k_islm = new kitap_islem();
        private void ekle_b_Click(object sender, EventArgs e)
        {
            ...
            int sonuc = k_islm.ktp_ekle(ad_t.Text, yazar_t.Text, no_t.Text, tur_t.Text, int.Parse(ssayisi_t.Text));
            MessageBox.Show("Kitap Başarıyla Eklendi.");
        }
        private kitap_islem ktpekle = new kitap_islem();
        ...
        private kitap_islem ktp_islem = new kitap_islem();
        ...
        private kitap_islem ktp_guncelleme = new kitap_islem();
        private void guncelle_b_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int Sonuc = ktp_guncelleme.ktp_guncelle(int.Parse(id_t.Text), ad_t.Text, yazar_t.Text, no_t.Text, tur_t.Text, int.Parse(ssayisi_t.Text));
        ...
        private kitap_islem ktp_silme = new kitap_islem();
        ...
        private void kitap_listesi_d_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                ssayisi_t.Text = row.Cells[5].Value.ToString();
            }
        }
        private void kategori_cmb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            yer = kategori_cmb.SelectedItem.ToString();
        }
        ...
        private void ktp_ara_b_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<kitaplar> ktp2 = ktp_islem.kitap_goster(ktp_ara_t.Text, yer);
        ...
        private void ssayisi_t_click(object sender, EventArgs e)
        {
            ssayisi_t.Text = "";
        }        
    }
