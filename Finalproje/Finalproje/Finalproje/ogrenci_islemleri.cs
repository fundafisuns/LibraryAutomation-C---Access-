...
namespace Finalproje
{
    public partial class ogrenci_islemleri : Form
    {
        ...
        private ogrenci_islem o_islm = new ogrenci_islem();
        private void ekle_b_Click(object sender, EventArgs e)
        {
            ...
            int sonuc = o_islm.ogr_ekle(isim_t.Text, numara_t.Text, bolum_t.Text, sehir_t.Text);
        ...
        private void guncelle_b_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int sonuc = o_islm.ogr_guncelle(int.Parse(id_t.Text), isim_t.Text, numara_t.Text, bolum_t.Text, sehir_t.Text);
        ...
        private ogrenci_islem o_sill = new ogrenci_islem();
        ...
        private ogrenci_islem o_list = new ogrenci_islem();
        private void ogr_gstr()
        {
        ...
        private void ogrenci_listesi_d_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                sehir_t.Text = row.Cells[4].Value.ToString();
            }
        }
        ...
        private void sehir_t_Click(object sender, EventArgs e)
        {
            //textbox içindeki yazılar silinir.
            sehir_t.Text = "";
        }
